...
#         pred_loss, con_loss, epoch_pr1, epoch_pr2, loss1, loss2 = train(args, Model, Predict_1, Predict_2, loss_fun, opt, opt1, opt2, trainLoader_1, trainLoader_2, trainULoader)
    ...
    r_gCSI_N, pval1, sr_gCSI_N, pval2, pred_PRAD, pred_KIRC = heldout_testF(args, Model, Predict_1, Predict_2, [torch.mean(torch.stack(w1)), torch.mean(torch.stack(w2))], PRAD_N, KIRC_N, gCSI_N, gCSI_aac_drug)  
